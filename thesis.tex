...
The RESTful API is used by the command line interface and web clients. Web clients are implemented in various languages such as .NET, JavaScript, Python and many others.
