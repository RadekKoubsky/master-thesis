...
\section{Strucure of Wildfly}
The structure of Wildfly has been changed in past years due to maintainability and performance. In the version JBoss AS 7, the core of the server was changed and consists of two parts \cite{jboss_as_book}:
...
The core described above has remained to the last version of Wildfly. The following diagram illustrates basic structure of the Wildfly core \cite{wildfly_book}:

\begin{figure}[ht!]
	\centering
	\includegraphics[width=150mm]{images/wildfly_core}
