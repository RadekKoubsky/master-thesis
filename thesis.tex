...
The main requirement of this work is to extend Wildfly logging capabilities. The result of such extension should include ability to log events to Elasticsearch, visualize log events using Kibana tool and add new log events to selected parts of the Wildfly without modifying Wildfly source code. This requirement can be split into the following set of functional requirements:

\begin{itemize}
	\item Log events to Elasticsearch
	\item Visualize log events using Kibana
	\item Add new log events to selected parts of the Wildfly
\end{itemize}
