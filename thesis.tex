...
\chapter{Wildfly}
In this chapter, the Wildfly Application server will be described. Because of the size of the server, only specific part will be mentioned and description of its internal structure and configuration will be provided. Further information about Wildfly can be found at official website \url{http://wildfly.org/}. Wildfly 8 Documetation \cite{wildfly_doc} is used as the main source for this chapter.

Wildfly is one of the leading application servers in enterprise world. From \cite[Getting Started with WildFly 8]{wildfly_doc}: ''WildFly 8 is an exceptionally fast, lightweight and powerful implementation of the Java Enterprise Edition 7 Platform specifications.''
